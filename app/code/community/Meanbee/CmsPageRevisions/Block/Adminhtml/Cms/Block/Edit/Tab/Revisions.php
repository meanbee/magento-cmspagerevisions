<?php
class Meanbee_CmsPageRevisions_Block_Adminhtml_Cms_Block_Edit_Tab_Revisions extends Mage_Adminhtml_Block_Widget_Grid implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        $collection = Mage::getModel('meanbee_cmspagerevisions/cms_block_revisions')->getCollection()
            ->addFieldToFilter('block_id', array('eq' => $this->getRequest()->getParam('block_id')));
